...
function insertMyTokenHTML(nft_id, nft_sub_id) {
  ...
  if (nft_id == 1) {
    token_imagen.src = "44d164d1-1338-4d5a-9a8f-6f8f23f97b6f.jpg"
  } else if (nft_id == 2) {
    token_imagen.src = "NFT_Jessica2D_Marco_COMUN_mini.png"
  } else if (nft_id == 3) {
    token_imagen.src = "NFT_JessicaPistola_Marco_POCOCOMUN_mini.png"
  } else if (nft_id == 4) {
    token_imagen.src = "NFT_JessicaVR_Marco_SUPER_mini.png"
  } else if (nft_id == 5) {
    token_imagen.src = "NFT_JessicaArcade_Marco_RARO_mini.png"
  } else if (nft_id == 6) {
    token_imagen.src = "NFT_JessicaBuggie_Marco_EPICO_mini.png"
  } else if (nft_id == 7) {
    token_imagen.src = "NFT_JessicaTanque_Marco_LEGENDARIO_mini.png"
  } else if (nft_id == 8) {
    token_imagen.src = "NFT_JessicaLiberator_Marco_BARBARO_mini.png"
  } else if (nft_id == 9) {
    token_imagen.src = "NFT_JessicaBattleCruiser_Marco_DESTRUCTOR_mini.png"
  }
